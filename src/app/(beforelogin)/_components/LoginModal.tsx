...
export default function LoginModal() {
  ...
  return (
    <div className="modalBackground">
      <div className="bg-WHITE relative top-[5%] max-w-4/5vw min-w-600pxr rounded-modal flex flex-col h-450pxr">
        ...
        <form className="flex flex-col flex-1" onSubmit={onSubmit}>
          ...
          <div className="text-red flex justify-center font-bold">{message}</div>
